      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div class="flex items-center">
            ...
            <div class="ml-4">
              <h3 class="text-lg font-medium text-gray-900">NFC Codes</h3>
              <p class="text-sm text-gray-500">Manage NFC codes and property assignments</p>
            </div>
          </div>
        </NuxtLink>
          ...
          <div class="flex gap-4">
            ...
            <div>
              ...
              <select 
                v-model="roleFilter" 
                @change="searchUsers"
                class="px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#8ee0ee] focus:border-[#8ee0ee]0"
              >
